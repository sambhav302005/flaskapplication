...
problems = {
    "Two Sum": {
        ...
        "hints": ["Try brute force first.", "Optimize using a HashMap."]
    },
    "Reverse String": {
        ...
        "hints": ["Use two pointers.", "Try Python slicing."]
    },
    "Valid Parentheses": {
        ...
        "constraints": ["1 <= s.length <= 10⁴"],
        "hints": ["Use a stack.", "Push opening brackets and match with closing."]
    }
}
...
def index():
    if request.method == "POST":
        ...
        details = problems.get(problem_title, {"description": "Not found", "difficulty": "N/A", "category": "N/A", "examples": [], "constraints": [], "hints": []})
    ...
    recent_submissions = submissions[-5:][::-1]  # last 5 submissions
...
def api_analyze():
    ...
    return jsonify(analyze_solution(code))
